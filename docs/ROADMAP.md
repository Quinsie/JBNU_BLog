...
| Phase | 내용 | 상태 |
|---|---|---|
| 0 | 환경/구조 셋업 (리포·디렉토리·경로·공유데이터·문서) | 진행중 |
| 1 | **robust 수집기** (raw 무손실: 버스 5초 / 교통 1분 / 날씨 / 사고) | 대기 |
| 2 | 정적 데이터 정비 (446 노선·정류장·시간표·격자·route_nodes) | 대기 |
| 3 | 후처리 (trip 재구성·매칭·이상치·통계·feature 가공) | 대기 |
| 4 | 1차 모델 (사전 ETA) — MLP vs GBDT 실험 | 대기 |
| 5 | 2차 모델 (실시간 ETA) — Attention-Transformer 시계열 | 대기 |
| 6 | Agent (목표 도착형 이동계획 의사결정) | 대기 |
| 7 | serve API + Flutter 앱 (iOS/Android) | 대기 |
